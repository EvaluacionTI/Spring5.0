package pe.etg.bbva.spring5.model.mapper.oracle;
...
public class CD01TipoPlanRowMapper implements RowMapper<CE01TipoPlan> {
	...
	public CE01TipoPlan mapRow(ResultSet poRS, int iRowNumber) throws SQLException {
		...
		oCETipoPlan.setSiNoVisualizar(poRS.getString("sn_ver"));
		oCETipoPlan.setSiNoEditar(poRS.getString("sn_upd"));
		oCETipoPlan.setSiNoAnula(poRS.getString("sn_del"));
		oCETipoPlan.setSiNoElimina(poRS.getString("sn_anu"));
		oCETipoPlan.setSiNoDefault(poRS.getString("sn_dflt"));
		oCETipoPlan.setSiNoActivo(poRS.getString("sn_act"));
