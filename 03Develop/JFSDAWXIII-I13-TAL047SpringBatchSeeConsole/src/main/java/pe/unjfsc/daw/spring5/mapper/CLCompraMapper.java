...
public class CLCompraMapper implements FieldSetMapper<CECompraDTOEntrada> {
	...
	private CECompraDTOEntrada oCompraEntrada;
	...
	public CECompraDTOEntrada mapFieldSet(FieldSet poFieldSet) throws BindException {
		...
		MOLOG.info("[EVL] CECompraDTOEntrada : {} ", poFieldSet.toString());
	...
	public void setoCompraEntrada(CECompraDTOEntrada oCompraEntrada) {
		this.oCompraEntrada = oCompraEntrada;
	}
