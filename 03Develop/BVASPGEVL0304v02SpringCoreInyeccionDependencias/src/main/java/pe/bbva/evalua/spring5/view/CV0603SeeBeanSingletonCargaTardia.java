...
public class CV0603SeeBeanSingletonCargaTardia {
	private static final Logger LOG = LoggerFactory.getLogger("CV0603SeeBeanSingletonCargaTardia");
	
	public static void main(String[] args) {
		LOG.info("[EVL] Start");
		LOG.info("[EVL] Load tardia indica que se instancia cuando se requiere a traves del getBean");
		LOG.info("[EVL] Permite el manejo del rendimiento");
		ApplicationContext oCntx = new ClassPathXmlApplicationContext("context0603-beanSingletonCargaTardia.xml");
