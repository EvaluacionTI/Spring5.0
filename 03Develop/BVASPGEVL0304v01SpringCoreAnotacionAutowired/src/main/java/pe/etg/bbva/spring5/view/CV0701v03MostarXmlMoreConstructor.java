...
public class CV0701v03MostarXmlMoreConstructor {
	private static final Logger MOLOG = LoggerFactory.getLogger(CV0701v03MostarXmlMoreConstructor.class);
	private static ApplicationContext oCntx;
	
	public static void main(String[] args) {
		MOLOG.info("[EVL] Start");
		MOLOG.info("[EVL] Antes de instanciar el Context : {}", oCntx);
		oCntx = new ClassPathXmlApplicationContext("classpath:/spring5/spring0701v03-person-moreconstructor.xml");
