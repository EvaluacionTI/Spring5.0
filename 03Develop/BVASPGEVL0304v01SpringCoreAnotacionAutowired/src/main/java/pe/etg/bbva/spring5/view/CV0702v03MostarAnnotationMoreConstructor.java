...
import pe.etg.bbva.spring5.configuration.CC0702v03ConfigurationMorePerson;
import pe.etg.bbva.spring5.entity.CE0701v01Person;

public class CV0702v03MostarAnnotationMoreConstructor {
	private static final Logger MOLOG = LoggerFactory.getLogger(CV0702v03MostarAnnotationMoreConstructor.class);
	...
	public static void main(String[] args) {
		...
		oCntx.register(CC0702v03ConfigurationMorePerson.class);
		oCntx.refresh();
