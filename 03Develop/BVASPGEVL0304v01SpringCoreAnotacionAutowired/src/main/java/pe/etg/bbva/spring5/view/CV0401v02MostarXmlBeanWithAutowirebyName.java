...
public class CV0401v02MostarXmlBeanWithAutowirebyName {
	private static final Logger MOLOG = LoggerFactory.getLogger(CV0401v02MostarXmlBeanWithAutowirebyName.class);
	private static ApplicationContext oCntx;
	
	public static void main(String[] args) {
		MOLOG.info("[EVL] Start");
		MOLOG.info("[EVL] Antes de instanciar el Context : {}", oCntx);
		oCntx = new ClassPathXmlApplicationContext("classpath:/spring5/spring0401v02-tag-autowire-byName.xml");
