...
/**
 * Test for transaction QWPUT20101PETransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/QWPUT20101PETest.xml" })
public class QWPUT20101PETransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(QWPUT20101PETransactionTest.class);
	
	@Autowired
	private QWPUT20101PETransaction transaction;
