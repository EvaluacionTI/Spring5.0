...
/**
 * Test for transaction QWPUT00001PETransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/QWPUT00001PETest.xml" })
public class QWPUT00001PETransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(QWPUT00001PETransactionTest.class);
	
	@Autowired
	private QWPUT00001PETransaction transaction;
