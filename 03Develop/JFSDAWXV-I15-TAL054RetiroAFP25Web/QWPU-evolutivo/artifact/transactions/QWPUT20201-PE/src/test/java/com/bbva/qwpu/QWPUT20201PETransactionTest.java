...
/**
 * Test for transaction QWPUT20201PETransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/QWPUT20201PETest.xml" })
public class QWPUT20201PETransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(QWPUT20201PETransactionTest.class);
	
	@Autowired
	private QWPUT20201PETransaction transaction;
