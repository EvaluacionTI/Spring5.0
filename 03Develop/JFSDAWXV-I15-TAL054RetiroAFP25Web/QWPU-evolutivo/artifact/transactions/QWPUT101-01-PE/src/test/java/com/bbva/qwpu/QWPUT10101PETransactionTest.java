...
/**
 * Test for transaction QWPUT10101PETransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/QWPUT10101PETest.xml" })
public class QWPUT10101PETransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(QWPUT10101PETransactionTest.class);

	@Autowired
	private QWPUT10101PETransaction transaction;
