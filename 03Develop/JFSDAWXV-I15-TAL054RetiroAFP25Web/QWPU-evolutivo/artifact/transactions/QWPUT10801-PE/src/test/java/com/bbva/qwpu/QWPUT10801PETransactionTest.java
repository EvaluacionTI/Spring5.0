...
/**
 * Test for transaction QWPUT10801PETransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/QWPUT10801PETest.xml" })
public class QWPUT10801PETransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(QWPUT10801PETransactionTest.class);
	
	@Autowired
	private QWPUT10801PETransaction transaction;
