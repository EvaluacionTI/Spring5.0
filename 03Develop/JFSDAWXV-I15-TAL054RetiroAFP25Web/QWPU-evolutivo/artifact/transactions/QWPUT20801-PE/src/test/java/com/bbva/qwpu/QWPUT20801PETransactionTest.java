...
/**
 * Test for transaction QWPUT20801PETransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/QWPUT20801PETest.xml" })
public class QWPUT20801PETransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(QWPUT20801PETransactionTest.class);
	
	@Autowired
	private QWPUT20801PETransaction transaction;
