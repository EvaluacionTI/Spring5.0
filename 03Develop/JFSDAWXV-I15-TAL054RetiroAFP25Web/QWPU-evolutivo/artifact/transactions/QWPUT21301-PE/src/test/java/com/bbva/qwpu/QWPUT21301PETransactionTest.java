...
/**
 * Test for transaction QWPUT21301PETransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/QWPUT21301PETest.xml" })
public class QWPUT21301PETransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(QWPUT21301PETransactionTest.class);
	
	@Autowired
	private QWPUT21301PETransaction transaction;
