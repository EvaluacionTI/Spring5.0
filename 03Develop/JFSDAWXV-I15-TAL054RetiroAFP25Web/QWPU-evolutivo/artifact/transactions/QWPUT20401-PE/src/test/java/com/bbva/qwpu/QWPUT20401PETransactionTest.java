...
/**
 * Test for transaction QWPUT20401PETransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/QWPUT20401PETest.xml" })
public class QWPUT20401PETransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(QWPUT20401PETransactionTest.class);
	
	@Autowired
	private QWPUT20401PETransaction transaction;
