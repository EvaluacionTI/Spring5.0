...
/**
 * Test for transaction QWPUT21501PETransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/QWPUT21501PETest.xml" })
public class QWPUT21501PETransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(QWPUT21501PETransactionTest.class);
	
	@Autowired
	private QWPUT21501PETransaction transaction;
