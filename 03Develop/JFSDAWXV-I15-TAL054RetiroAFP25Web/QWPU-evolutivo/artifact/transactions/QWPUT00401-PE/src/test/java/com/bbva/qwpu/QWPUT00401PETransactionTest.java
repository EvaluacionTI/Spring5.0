...
/**
 * Test for transaction QWPUT00401PETransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/QWPUT00401PETest.xml" })
public class QWPUT00401PETransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(QWPUT00401PETransactionTest.class);
	
	@Autowired
	private QWPUT00401PETransaction transaction;
