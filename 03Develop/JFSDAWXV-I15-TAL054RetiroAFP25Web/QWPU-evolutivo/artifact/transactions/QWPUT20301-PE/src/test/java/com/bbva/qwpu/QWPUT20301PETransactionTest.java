...
/**
 * Test for transaction QWPUT20301PETransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/QWPUT20301PETest.xml" })
public class QWPUT20301PETransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(QWPUT20301PETransactionTest.class);
	
	@Autowired
	private QWPUT20301PETransaction transaction;
