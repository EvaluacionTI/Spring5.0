...
/**
 * Test for transaction QWPUT21201PETransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/QWPUT21201PETest.xml" })
public class QWPUT21201PETransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(QWPUT21201PETransactionTest.class);
	
	@Autowired
	private QWPUT21201PETransaction transaction;
