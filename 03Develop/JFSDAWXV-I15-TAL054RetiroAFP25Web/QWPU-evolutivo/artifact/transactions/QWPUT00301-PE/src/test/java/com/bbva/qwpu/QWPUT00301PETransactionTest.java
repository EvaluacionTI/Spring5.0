...
/**
 * Test for transaction QWPUT00301PETransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/QWPUT00301PETest.xml" })
public class QWPUT00301PETransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(QWPUT00301PETransactionTest.class);
	
	@Autowired
	private QWPUT00301PETransaction transaction;
