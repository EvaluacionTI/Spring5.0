...
/**
 * Test for transaction QWPUT21001PETransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/QWPUT21001PETest.xml" })
public class QWPUT21001PETransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(QWPUT21001PETransactionTest.class);
	
	@Autowired
	private QWPUT21001PETransaction transaction;
