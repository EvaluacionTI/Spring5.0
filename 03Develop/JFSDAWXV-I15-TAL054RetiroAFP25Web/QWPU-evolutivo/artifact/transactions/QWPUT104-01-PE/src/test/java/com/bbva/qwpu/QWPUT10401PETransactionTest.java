...
/**
 * Test for transaction QWPUT10401PETransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/QWPUT10401PETest.xml" })
public class QWPUT10401PETransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(QWPUT10401PETransactionTest.class);

	@Autowired
	private QWPUT10401PETransaction transaction;
