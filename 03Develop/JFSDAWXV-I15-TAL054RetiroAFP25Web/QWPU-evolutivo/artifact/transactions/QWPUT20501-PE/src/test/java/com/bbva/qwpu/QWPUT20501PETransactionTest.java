...
/**
 * Test for transaction QWPUT20501PETransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/QWPUT20501PETest.xml" })
public class QWPUT20501PETransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(QWPUT20501PETransactionTest.class);
	
	@Autowired
	private QWPUT20501PETransaction transaction;
