...
/**
 * Test for transaction QWPUT20001PETransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/QWPUT20001PETest.xml" })
public class QWPUT20001PETransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(QWPUT20001PETransactionTest.class);
	
	@Autowired
	private QWPUT20001PETransaction transaction;
