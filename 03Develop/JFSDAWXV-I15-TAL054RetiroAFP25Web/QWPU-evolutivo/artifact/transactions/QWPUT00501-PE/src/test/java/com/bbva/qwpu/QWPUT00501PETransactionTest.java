...
/**
 * Test for transaction QWPUT00501PETransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/QWPUT00501PETest.xml" })
public class QWPUT00501PETransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(QWPUT00501PETransactionTest.class);
	
	@Autowired
	private QWPUT00501PETransaction transaction;
