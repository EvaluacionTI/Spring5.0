...
/**
 * Test for transaction QWPUT10301PETransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/QWPUT10301PETest.xml" })
public class QWPUT10301PETransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(QWPUT10301PETransactionTest.class);

	@Autowired
	private QWPUT10301PETransaction transaction;
