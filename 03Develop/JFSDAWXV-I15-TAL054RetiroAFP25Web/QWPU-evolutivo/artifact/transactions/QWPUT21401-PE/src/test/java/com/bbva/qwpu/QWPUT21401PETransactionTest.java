...
/**
 * Test for transaction QWPUT21401PETransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/QWPUT21401PETest.xml" })
public class QWPUT21401PETransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(QWPUT21401PETransactionTest.class);
	
	@Autowired
	private QWPUT21401PETransaction transaction;
