...
/**
 * Test for transaction QWPUT10201PETransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/QWPUT10201PETest.xml" })
public class QWPUT10201PETransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(QWPUT10201PETransactionTest.class);

	@Autowired
	private QWPUT10201PETransaction transaction;
