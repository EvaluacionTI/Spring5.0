...
/**
 * Test for transaction QWPUT10001PETransaction
 */
/*
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/QWPUT10001PETest.xml" })
public class QWPUT10001PETransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(QWPUT10001PETransactionTest.class);
	
	@Autowired
	private QWPUT10001PETransaction transaction;
