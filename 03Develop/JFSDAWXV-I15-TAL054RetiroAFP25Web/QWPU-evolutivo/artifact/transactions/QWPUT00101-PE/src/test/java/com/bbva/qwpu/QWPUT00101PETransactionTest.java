...
/**
 * Test for transaction QWPUT00101PETransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/QWPUT00101PETest.xml" })
public class QWPUT00101PETransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(QWPUT00101PETransactionTest.class);
	
	@Autowired
	private QWPUT00101PETransaction transaction;
