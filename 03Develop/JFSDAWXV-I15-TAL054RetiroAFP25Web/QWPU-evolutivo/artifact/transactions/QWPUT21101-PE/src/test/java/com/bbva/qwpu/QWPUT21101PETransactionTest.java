...
/**
 * Test for transaction QWPUT21101PETransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/QWPUT21101PETest.xml" })
public class QWPUT21101PETransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(QWPUT21101PETransactionTest.class);
	
	@Autowired
	private QWPUT21101PETransaction transaction;
