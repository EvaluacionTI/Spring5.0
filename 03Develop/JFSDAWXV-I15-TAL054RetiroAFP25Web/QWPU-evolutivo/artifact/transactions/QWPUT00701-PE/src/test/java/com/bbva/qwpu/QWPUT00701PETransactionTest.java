...
/**
 * Test for transaction QWPUT00701PETransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/QWPUT00701PETest.xml" })
public class QWPUT00701PETransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(QWPUT00701PETransactionTest.class);
	
	@Autowired
	private QWPUT00701PETransaction transaction;
