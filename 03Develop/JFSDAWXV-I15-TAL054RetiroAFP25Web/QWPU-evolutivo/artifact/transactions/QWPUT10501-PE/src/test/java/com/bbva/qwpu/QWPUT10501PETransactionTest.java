...
/**
 * Test for transaction QWPUT10501PETransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/QWPUT10501PETest.xml" })
public class QWPUT10501PETransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(QWPUT10501PETransactionTest.class);
	
	@Autowired
	private QWPUT10501PETransaction transaction;
