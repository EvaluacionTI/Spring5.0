...
/**
 * Test for transaction PGLUT00101PETransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/PGLUT00101PETest.xml" })
public class PGLUT00101PETransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(PGLUT00101PETransactionTest.class);

	@Autowired
	private PGLUT00101PETransaction transaction;
