...
/**
 * Test for transaction PGLUT00701PETransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/PGLUT00701PETest.xml" })
public class PGLUT00701PETransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(PGLUT00701PETransactionTest.class);

	@Autowired
	private PGLUT00701PETransaction transaction;
