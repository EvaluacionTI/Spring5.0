...
/**
 * Test for transaction PGLUT00201PETransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/PGLUT00201PETest.xml" })
public class PGLUT00201PETransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(PGLUT00201PETransactionTest.class);

	@Autowired
	private PGLUT00201PETransaction transaction;
