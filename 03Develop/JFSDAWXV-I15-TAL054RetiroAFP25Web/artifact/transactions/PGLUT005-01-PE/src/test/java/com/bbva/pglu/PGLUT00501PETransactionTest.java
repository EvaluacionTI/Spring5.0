...
/**
 * Test for transaction PGLUT00501PETransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/PGLUT00501PETest.xml" })
public class PGLUT00501PETransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(PGLUT00501PETransactionTest.class);

	@Autowired
	private PGLUT00501PETransaction transaction;
