...
/**
 * Test for transaction PAPXT00601PETransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/PAPXT00601PETest.xml" })
public class PAPXT00601PETransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(PAPXT00601PETransactionTest.class);

	@Autowired
	private PAPXT00601PETransaction transaction;
