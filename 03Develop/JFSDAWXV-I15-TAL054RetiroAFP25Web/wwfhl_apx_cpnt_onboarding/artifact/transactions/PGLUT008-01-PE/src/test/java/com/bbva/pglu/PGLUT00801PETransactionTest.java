...
/**
 * Test for transaction PGLUT00801PETransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/PGLUT00801PETest.xml" })
public class PGLUT00801PETransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(PGLUT00801PETransactionTest.class);

	@Autowired
	private PGLUT00801PETransaction transaction;
