...
/**
 * Test for transaction PGLUT00401PETransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/PGLUT00401PETest.xml" })
public class PGLUT00401PETransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(PGLUT00401PETransactionTest.class);

	@Autowired
	private PGLUT00401PETransaction transaction;
