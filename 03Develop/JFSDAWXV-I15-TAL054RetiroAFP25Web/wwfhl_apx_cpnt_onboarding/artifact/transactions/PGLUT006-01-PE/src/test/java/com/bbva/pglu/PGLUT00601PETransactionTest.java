...
/**
 * Test for transaction PGLUT00601PETransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/PGLUT00601PETest.xml" })
public class PGLUT00601PETransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(PGLUT00601PETransactionTest.class);

	@Autowired
	private PGLUT00601PETransaction transaction;
