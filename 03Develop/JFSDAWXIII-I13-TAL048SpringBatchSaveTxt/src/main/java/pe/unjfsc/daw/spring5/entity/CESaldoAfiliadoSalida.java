...
public class CESaldoAfiliadoSalida {
	private String codigo;
	private String codigoAfiliado;
	private double saldoCIC;
	public CESaldoAfiliadoSalida() {}
	
	public CESaldoAfiliadoSalida(String pCodigo, String pAfiliado, double pSaldo) {
		this.codigo = pCodigo;
	...
	public String toString() {
		...
		builder.append("CESaldoAfiliadoSalida [codigo=");
