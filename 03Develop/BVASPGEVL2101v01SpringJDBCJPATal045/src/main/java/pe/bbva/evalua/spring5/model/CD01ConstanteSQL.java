...
public final class CD01ConstanteSQL {
	...
	// o al esquema que se ha definido (EIAS) para la base de datos aemsadesarrollo
	public static final String SQL_SCHEMA = "aemsa.";
	public static final String SQL_TABLE = "CTBt14_tipo_plan";
	public static final String SQL_INSERT = "INSERT INTO aemsa.CTBt14_tipo_plan (cod_tipo_plan, cod_emp, cod_iso_idio_orgn, txt_abrv, txt_desc, sn_ver, sn_upd, sn_anu, sn_del, sn_dflt, sn_act, txt_user, fec_user, txt_last_user, fec_last_user) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
	...
	public static final String SQL_JPA_SELECT_ALL = "SELECT e FROM CE01TipoPlan e";
}
