...
import pe.bbva.evalua.spring5.process.CLCompraProcessor;
import pe.bbva.evalua.spring5.writer.CUWriterJsonCompra;
...
public class CV0103v01RevisarContextJob {
	...
	public static void main(String[] psaLista) {
		...
		CUWriterJsonCompra oCDCompra = (CUWriterJsonCompra) moContext.getBean("idCompraWriter");
