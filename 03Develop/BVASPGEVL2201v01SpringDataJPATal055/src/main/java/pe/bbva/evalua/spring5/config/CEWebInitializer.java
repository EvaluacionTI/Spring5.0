...
public class CEWebInitializer implements WebApplicationInitializer {
	...
	public void onStartup(ServletContext servletContext) throws ServletException {
		...
		oCntx.setConfigLocation("pe.bbva.evalua.spring5.config.CEWebConfig");
		LOG.info("[EVL] New value Context : {}", oCntx);

		ServletRegistration.Dynamic oDispatcher = servletContext.addServlet("tal055SpringDataJPA", new DispatcherServlet(oCntx));
