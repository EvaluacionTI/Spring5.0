...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = {"pe.bbva"})
public class CEWebConfig extends WebMvcConfigurationSupport {
	private static final Logger LOG = LoggerFactory.getLogger("CEConfigWeb");
	
	@Bean
	public InternalResourceViewResolver getInternalResourceViewResolver() {
		LOG.info("[EVL] =====[ Start InternalResourceViewResolver ]=====");
