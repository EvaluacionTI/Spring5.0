...
@Controller
public class CC01Canal {
	private static final Logger MOLOG = LoggerFactory.getLogger(CC01Canal.class);
	
    @Autowired
	private CD01Canal oCDCanal;//will inject oCDCanal from xml file
	...
	public ModelAndView save(@ModelAttribute("emp") CE01Canal emp){
		MOLOG.info("=====> Start method : setUp() <===== ");
		oCDCanal.grabaCanal(emp);
		return new ModelAndView("redirect:/viewemp");//will redirect to viewemp request mapping
	}
	/* It provides list of employees in model object */
	@RequestMapping("/viewemp")
	public ModelAndView viewemp(){
		List<CE01Canal> list=oCDCanal.getEmployees();
