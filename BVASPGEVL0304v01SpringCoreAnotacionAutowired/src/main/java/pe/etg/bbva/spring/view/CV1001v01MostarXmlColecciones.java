...
import pe.etg.bbva.spring.entity.CE1001v01Ciudad;
import pe.etg.bbva.spring.entity.CE1003v01Person;
...
public class CV1001v01MostarXmlColecciones {
	...
	public static void main(String[] args) {
		...
		oCntx = new ClassPathXmlApplicationContext("classpath:/spring/spring1001v01-beans-colecciones.xml");
