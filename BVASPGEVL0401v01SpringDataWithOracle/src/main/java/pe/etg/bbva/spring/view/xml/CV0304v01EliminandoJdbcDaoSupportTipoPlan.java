...
public class CV0304v01EliminandoJdbcDaoSupportTipoPlan {
	private static Logger MOLOG = LoggerFactory.getLogger(CV0304v01EliminandoJdbcDaoSupportTipoPlan.class);
